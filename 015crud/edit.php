...
<head>
    ...
    <script src="http://localhost/BIT-backend/php/015crud/app.js" defer></script>
    <title>Edit</title>
</head>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="http://localhost/BIT-backend/php/015crud/update.php?id= <?= $_GET['id'] ?? 0 ?>" method="post">
                            <div class="mb-3">
