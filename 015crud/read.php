...
<!-- http://localhost/BIT-backend/php/015crud/read.php -->
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-2">
                <form action="http://localhost/BIT-backend/php/015crud/read.php" method="get">
                    <div class="mb-3">
                    ...
                    <a href="http://localhost/BIT-backend/php/015crud/read.php" class="btn btn-secondary">Clear</a>
                </form>
            </div>
        </div>
    </div>
    ...
    <ul class="list-group list-group-flush mt-5">
        ...
        <?php 
        if (isset($_GET['sort'])) {
            $boxes = match ($_GET['sort']) {
                'amount_asc' => usort($boxes, fn($a, $b) => $a['amount'] <=> $b['amount']),
                'amount_asc' => usort($boxes, fn($a, $b) => $b['amount'] <=> $a['amount']),
